...
Revenue is calculated at \(90\,\text{€}\) per device per month. From Year~6 onward, three additional hospitals (about 69 devices) are onboarded each year, so revenue grows annually.

Assuming an initial investment of \(430\,000\,\text{€}\), Table~\ref{tab:breakeven} projects cumulative cash flow based on the subscription revenue in Table~\ref{tab:revenue}. Cash flow becomes positive in Year~7.

\begin{table}[H]
\centering
\caption{Cumulative cash flow projection}
\label{tab:breakeven}
\begin{tabularx}{\linewidth}{c r}
\toprule
Year & Cumulative cash flow (\texteuro{}) \\
\midrule
0 & -430\,000 \\
1 & -421\,360 \\
2 & -412\,720 \\
...
\begin{itemize}
  ...
  Cumulative investment through Phase~C is about \(430\,000\,\text{€}\). With three hospitals added each year from Year~6 (about 69 additional devices annually), subscription revenue grows from \(149\,040\,\text{€}\) in Year~6 to \(447\,120\,\text{€}\) by Year~10. Cash flow turns positive around Year~7.
...
\begin{table}[H]
\centering
\caption{Initial investment for Phases~A--C}
\label{tab:init-investment}
\begin{tabularx}{\linewidth}{X r}
\toprule
\textbf{Category} & \textbf{Amount (\texteuro{})} \\
\midrule
Hardware engineering \& QA (NL) & 350\,000 \\
South African staffing & 39\,000 \\
Pilot hardware & 5\,000 \\
Travel & 24\,000 \\
Regulatory support & 12\,000 \\
\midrule
